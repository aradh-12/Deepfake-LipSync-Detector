...
def main():
    ...
    print("\n" + "=" * 60)
    print("EXP9 SMALLER TEMPORAL LSTM TRAINING")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print("BUILDING EXP9 SMALLER LSTM MODEL")
    print("=" * 60)
