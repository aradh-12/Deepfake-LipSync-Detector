...
def build_model(
    ...
    model = tf.keras.Model(
        ...
        name="EXP15_Temporal_Only_BiLSTM"
...
def main():
    ...
    print(
        ...
        "EXP15 TEMPORAL FEATURES ONLY TRAINING"
