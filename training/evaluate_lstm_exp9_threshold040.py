...
print("\n" + "=" * 60)
print("EXP9 FINAL TEST EVALUATION")
...
print(
    f"Test videos: {len(unique_videos)}"
)
...
for video_id in unique_videos:
    ...
    video_sequence_probabilities = (
        sequence_probabilities[indices]
    )
...
print("\n" + "=" * 60)
print("EXP9 FINAL TEST EVALUATION COMPLETED")
print("=" * 60)
