...
def process_unseen_fake_dataset():
    ...
    unseen_fake = all_videos[25:50]

    print("\n==============================")
    print("Unseen Fake Feature Fusion")
    print("==============================")
    ...
    print("\n==============================")
    print("Unseen Fake Feature Fusion Complete")
    print("==============================")
...
def align_mfcc_to_video(
    ...
    # The center of MFCC frame i is approximately:
    #
    # (i * hop_length + n_fft / 2) / sample_rate
    # --------------------------------------------------------
