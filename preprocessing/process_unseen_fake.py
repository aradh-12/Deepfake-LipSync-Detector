...
# --------------------------------------------------
# Get exact 25 unseen Fake videos
# --------------------------------------------------

def get_unseen_fake_videos():
...
def main():
    ...
    videos = get_unseen_fake_videos()

    print("\n==============================")
    print("Unseen Fake Video Preprocessing")
    print("==============================")
    ...
    print("\n==============================")
    print("Unseen Fake Preprocessing Complete")
    print("==============================")
